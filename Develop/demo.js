...
Because this is a CLI App, there will be no need to deploy it to Heroku. This time, though, you need to include a video showing us that you got the app working with no bugs. You should include a link to the video in your application's

* Create a .gitignore file and include node_modules/ and .DS_Store/.

* "node_modules" is not tracked and uploaded to GitHub. (Hint: It is easy if you create your no.gitignoreno file before installing dependencies with npm.)

* Repo **MUST** include "package.json" with required dependencies. (Hint: Run  when you first setup the project before installing any dependencies.)
...
`
fs.writeFile("timesreadme.md", content , err=> console.log(err||"success!"))